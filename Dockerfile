...
RUN dotnet build "TaskMnagementBackend.Api.csproj" -c Release -o /app/build --no-restore

FROM build AS publish

RUN dotnet publish "TaskMnagementBackend.Api.csproj" -c Release -o /app/publish /p:UseAppHost=false --no-restore
