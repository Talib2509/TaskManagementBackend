...
namespace TaskMnagementBackend.Infrastructure.Services
{
    public class NotificationService : INotificationService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            await _unitOfWork.NotificationWriteRepository
    ...
    CancellationToken cancellationToken = default)
        ...
        public Task<bool> ExistsAsync(int notificationId, Guid userId, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        public Task<PagedResult<NotificationDto>> GetUserNotificationsAsync(Guid userId, bool onlyUnread, int page, int pageSize, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
    }
